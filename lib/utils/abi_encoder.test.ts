import abiEncoder from "./abi_encoder";
...
describe("utils", () => {
  ...
  it("should return 2 complement of number 2", () => {
    const value = 2;
    const bitsSize = 64;
    expect(abiEncoder.twosComplement(value, bitsSize)).toBe(
      "fffffffffffffffe"
    );
  });
    ...
    types: {
      ...
      Teste: {
        ...
        fields: [
          ...
          { name: "opt_val", type: "Option<bool>" },
          { name: "opt_val2", type: "Option<bool>" },
          { name: "opt_val3", type: "Option<bool>" },
          { name: "list", type: "List<bool>" },
          { name: "custom_list", type: "List<Foo>" },
          { name: "custom_type", type: "Foo" },
        ],
      },
    },
  });
