...
goog.exportSymbol('proto.proto.Transaction.KDAFee', null, global);
 ...
 * @constructor
 */
proto.proto.Transaction.KDAFee = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.Transaction.KDAFee, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.Transaction.KDAFee.displayName = 'proto.proto.Transaction.KDAFee';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.proto.Transaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    gasmultiplier: jspb.Message.getFieldWithDefault(msg, 8, 0)
  };
 ...
 * @return {!Object}
 */
proto.proto.Transaction.KDAFee.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.Transaction.KDAFee.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.Transaction.KDAFee} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.Transaction.KDAFee.toObject = function(includeInstance, msg) {
  var f, obj = {
    kda: msg.getKda_asB64(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.Transaction.KDAFee}
 */
proto.proto.Transaction.KDAFee.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.Transaction.KDAFee;
  return proto.proto.Transaction.KDAFee.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.Transaction.KDAFee} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.Transaction.KDAFee}
 */
proto.proto.Transaction.KDAFee.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.Transaction.KDAFee.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.Transaction.KDAFee.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.Transaction.KDAFee} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.Transaction.KDAFee.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKda_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      1,
      f
...
/**
 * optional bytes KDA = 1;
 * @return {!(string|Uint8Array)}
 */
proto.proto.Transaction.KDAFee.prototype.getKda = function() {
...
/**
 * optional bytes KDA = 1;
 * This is a type-conversion wrapper around `getKda()`
 * @return {string}
 */
proto.proto.Transaction.KDAFee.prototype.getKda_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.proto.Transaction.KDAFee.prototype.getKda_asU8 = function() {
 ...
 * @return {!proto.proto.Transaction.KDAFee} returns this
 */
proto.proto.Transaction.KDAFee.prototype.setKda = function(value) {
 ...
 * @return {number}
 */
proto.proto.Transaction.KDAFee.prototype.getAmount = function() {
 ...
 * @return {!proto.proto.Transaction.KDAFee} returns this
 */
proto.proto.Transaction.KDAFee.prototype.setAmount = function(value) {
...
proto.proto.Transaction.Raw.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    kdafee: (f = msg.getKdafee()) && proto.proto.Transaction.KDAFee.toObject(includeInstance, f)
  };
...
proto.proto.Transaction.Raw.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 17:
      var value = new proto.proto.Transaction.KDAFee;
      reader.readMessage(value,proto.proto.Transaction.KDAFee.deserializeBinaryFromReader);
      msg.setKdafee(value);
      break;
    default:
      reader.skipField();
...
proto.proto.Transaction.Raw.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      17,
      f,
      proto.proto.Transaction.KDAFee.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional KDAFee KDAFee = 17;
 * @return {?proto.proto.Transaction.KDAFee}
 */
proto.proto.Transaction.Raw.prototype.getKdafee = function() {
  return /** @type{?proto.proto.Transaction.KDAFee} */ (
    jspb.Message.getWrapperField(this, proto.proto.Transaction.KDAFee, 17));
};


/**
 * @param {?proto.proto.Transaction.KDAFee|undefined} value
 * @return {!proto.proto.Transaction.Raw} returns this
*/
proto.proto.Transaction.Raw.prototype.setKdafee = function(value) {
 ...
 * @return {!proto.proto.Transaction.Raw} returns this
 */
proto.proto.Transaction.Raw.prototype.clearKdafee = function() {
  return this.setKdafee(undefined);
};
 ...
 * @return {boolean}
 */
proto.proto.Transaction.Raw.prototype.hasKdafee = function() {
 ...
 * @return {number}
 */
proto.proto.Transaction.prototype.getGaslimit = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
 ...
 * @return {!proto.proto.Transaction} returns this
 */
proto.proto.Transaction.prototype.setGaslimit = function(value) {
  return jspb.Message.setProto3IntField(this, 7, value);
};


/**
 * optional uint64 GasMultiplier = 8;
 * @return {number}
 */
proto.proto.Transaction.prototype.getGasmultiplier = function() {
 ...
 * @return {!proto.proto.Transaction} returns this
 */
proto.proto.Transaction.prototype.setGasmultiplier = function(value) {
